...
public class Display implements ActionListener
{
    ...
    public static ImageIcon getSuitIcon( int suit )
    {
        ...
        {
            case 0: // スペード
                icon = new ImageIcon("torannpu-main/img/S.jpg");
                return icon;
	
            case 1: // ハート
                icon = new ImageIcon("torannpu-main/img/H.jpg");
                return icon;
	
            case 2: // ダイヤ
                icon = new ImageIcon("torannpu-main/img/D.jpg");
                return icon;
	
            case 3: // クラブ
                icon = new ImageIcon("torannpu-main/img/c.jpg");
                return icon;
